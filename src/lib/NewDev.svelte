...
<div class="additio">
    ...
    {#if showModel}
        <Model
            ...
            <div class="radios">
                <h3>Are the Active ?</h3>
                <div class="radioBtns">
                    <label for="status">Yes</label> <input type="radio" name="status" value={true} bind:group={newDev.status} >
                    <label for="status">No</label> <input type="radio" name="status" value={false} bind:group={newDev.status} >
                </div>
            </div>
        </Model>
    {/if}
